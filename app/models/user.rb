class User < ApplicationRecord
  ...
  has_many :likes
  has_many :comments
  has_many :followers, foreign_key: 'following_key', class_name: 'Relationship', dependent: :destroy
  has_many :followings, foreign_key: 'follower_key', class_name: 'Relationship', dependent: :destroy
